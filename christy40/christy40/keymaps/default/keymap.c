...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_(
        ...
        _______,       KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  G_PSCR,  CA_DEL,  RGB_VAI, RGB_VAD,  _______,
                  _______,   _______, _______,            _______,   _______,                 _______, _______
    ),
    [2] = LAYOUT_(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
        KC_DEL,      A_F4,    KC_UP,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_QUOT,
        RESET,         KC_LEFT, KC_DOWN, KC_RGHT, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, RGB_SAI, RGB_SAD, _______,
                  _______,   _______, _______,            _______,   _______,                 _______, _______
    ),
